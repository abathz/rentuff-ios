...
export const UPDATE_DATE_CALENDAR = 'UPDATE_DATE_CALENDAR'
...
export const GET_ACCOUNT_BANK_USER = 'GET_ACCOUNT_BANK_USER'
...
// RENTER
export const UPDATE_DATA_RENTER = 'UPDATE_DATA_RENTER'
export const GET_HOME_CATEGORY = 'GET_HOME_CATEGORY'
export const GET_STUFF_RENTER_BY_CATEGORY = 'GET_STUFF_RENTER_BY_CATEGORY'
export const GET_STUFF_NEARBY_SUCCESS = 'GET_STUFF_NEARBY_SUCCESS'
export const GET_DETAILS_STUFF_SUCCESS = 'GET_DETAILS_STUFF_SUCCESS'
